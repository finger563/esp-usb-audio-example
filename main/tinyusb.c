...
esp_err_t tinyusb_driver_install(const tinyusb_config_t *config)
{
    ...
    ESP_RETURN_ON_FALSE(config->string_descriptor, ESP_ERR_INVALID_ARG, TAG, "String descriptor must be provided for this device");
    ...
    ESP_RETURN_ON_FALSE(config->device_descriptor, ESP_ERR_INVALID_ARG, TAG, "Device descriptor must be provided for this device");
